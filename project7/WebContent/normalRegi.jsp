			    ...
			    <div class="card">
			        ...
			        <div class="card-body">
			            <form class="form-horizontal" id="fileForm" method="post" action="#" enctype="multipart/form-data">
				            ...
				            <br>
				            <div class="form-group">
				            	<button type="button" id="regiBtn" class="btn btn-primary btn-lg btn-block login-button" disabled="disabled">회원 가입</button>
				            </div>
					...
					$("#phoneNum1").val() == null || $("#phoneNum1").val() == "" ||
							$("#phoneNum2").val() == null || $("#phoneNum2").val() == "" ||
								$("#phoneNum3").val() == null || $("#phoneNum3").val() == "" ||
									$("#email").val() == null || $("#email").val() == "" || authSuccess == false) {
