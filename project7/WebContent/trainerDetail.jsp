          ...
          <section class="bar">
            <div class="row">
              <div class="col-md-12">
                ...
                <p class="lead"><strong>${bbs.title }</strong></p>
              </div>
            </div>
            <div class="row">
              <div class="col-md-7">
            ...
            <div class="row">
              <div class="col-md-4">
                ...
                <ul class="social list-inline">
                  <li class="list-inline-item"><a href="${trainerDto.faceLink }" class="external facebook"><i class="fa fa-facebook"></i></a></li>
                  <li class="list-inline-item"><a href="${trainerDto.instaLink }" class="external gplus"><i class="fa fa-google-plus"></i></a></li>
                  <li class="list-inline-item"><a href="${writerDto.email }" class="email"><i class="fa fa-envelope"></i></a></li>
                </ul>
              </div>
              <div class="col-md-4">
                <div class="heading">
