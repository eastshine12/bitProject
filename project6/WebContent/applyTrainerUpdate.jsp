...
<div class="container">
	<div class="row justify-content-center">
		<form action="bbs" method="post">
			<input type="hidden" name="param" value="updateBbs">
			...
			<div class="col-md-15 col-md-offset-1">
				<table class="table table-bordered" border ="1" >
					...
					<tr>
						<th>제목</th>
						<td>
						<input type="text" size="50" name="title" value="${bbs.title }">
						</td>
					</tr>
					<tr>
						<th>내용</th>
						<td>
						<textarea rows="20" cols="100" name="content">${bbs.content }</textarea>
						</td>
					</tr>
				</table>
				<div class="row justify-content-center">
					<input type="submit" class="btn btn-primary" value="글수정">
					<input type="button" class="btn btn-secondary" value="뒤로" onclick="location.href='bbs?param=goApplyTrainerPage'">
				</div>
			</div>
		</form>
	</div>
