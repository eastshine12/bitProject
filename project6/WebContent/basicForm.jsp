            ...
            <div id="navigation" class="navbar-collapse collapse">
              <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown"><a href="javascript: void(0)" data-toggle="dropdown" class="dropdown-toggle">트레이너 <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li class="dropdown-item"><a href="contact.html" class="nav-link">이용 방법</a></li>
                    <li class="dropdown-item"><a href="contact2.html" class="nav-link">트레이너 소개</a></li>
                    <li class="dropdown-item"><a href="contact3.html" class="nav-link">트레이너 신청</a></li>
                  </ul>
                </li>
                <li class="nav-item dropdown"><a href="javascript: void(0)" data-toggle="dropdown" class="dropdown-toggle">커뮤니티 <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li class="dropdown-item"><a href="contact.html" class="nav-link">자유게시판</a></li>
                    <li class="dropdown-item"><a href="contact2.html" class="nav-link">Q&A</a></li>
                    <li class="dropdown-item"><a href="contact3.html" class="nav-link">바디프로필</a></li>
                  </ul>
                </li>
                <!-- ============= Dropdown 메뉴 END ===============-->
              </ul>
