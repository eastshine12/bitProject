		...
		<div class="row justify-content-center">
				...
				<div class="col-md-15 col-md-offset-1">
					<table class="table table-bordered" border ="1" >
						...
						<tr>
							<th>이름</th>
							<td style="padding-left: 10px">${mem.name }</td>
						</tr>
						<tr>
							<th>작성날짜</th>
						...
						<tr>
							<th>제목</th>
							<td style="padding-left: 10px">${bbs.title }</td>
						</tr>
						<tr>
							<th>조회수</th>
							<td style="padding-left: 10px">${bbs.readcount }</td>
						</tr>
						<tr>
							<th>추천</th>
							<td style="padding-left: 10px">${bbs.likecount }</td>
						</tr>
						<tr>
							<th>내용</th>
							<td>
							<textarea rows="20" cols="100" name="content" readonly>${bbs.content }</textarea>
							</td>
						</tr>
					</table>
					<div class="row justify-content-center">
