                ...
                <div class="row products">
                  ...
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      ...
                      <div class="text">
                        <h3 class="h5"><a href="shop-detail.html">1:1 전문 코칭 강남 xx휘트니스</a></h3>
                  ...
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      ...
                      <div class="text">
                        <h3 class="h5"><a href="shop-detail.html">[합정PT,상수PT]허니짐 트레이너 쩡샘의 디테일한 1:1 PT</a></h3>
                        <p class="price">
                  ...
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      ...
                      <div class="text">
                        <h3 class="h5"><a href="shop-detail.html">원주 피티 / 범트레이너 PT 1:1</a></h3>
                  ...
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      ...
                      <div class="text">
                        <h3 class="h5"><a href="shop-detail.html">신중동 PT_일호핏 2호점 1:1... 재활트레이너, 필라테스 강사</a></h3>
                  ...
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      ...
                      <div class="text">
                        <h3 class="h5"><a href="shop-detail.html">랩스휘트니스 구로구청점 강현철트레이너</a></h3>
                        <p class="price">
                  ...
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      ...
                      <div class="text">
                        <h3 class="h5"><a href="shop-detail.html">중계동PT / 운동치료사 트레이너와 1:1 PT, SN휘트니스</a></h3>
                  ...
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      ...
                      <div class="text">
                        <h3 class="h5"><a href="shop-detail.html">헬로우짐 일산 전문 트레이너 소개 / 1:1 개인 PT / 일산 피티</a></h3>
                  ...
                  <div class="col-lg-3 col-md-4">
                    <div class="product">
                      ...
                      <div class="text">
                        <h3 class="h5"><a href="shop-detail.html">[인계동 원테이크짐] 1:1 PT 트레이너 소개 !!</a></h3>
                        <p class="price">250,000원</p>
                      </div>
                    </div>
                  </div>
