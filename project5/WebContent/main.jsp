...
<div align="right">
	<input id="loginBtn" type="button" class="btn btn-dark" value="로그인">
	<input id="regiBtn" type="button" class="btn btn-dark" value="회원가입">
</div>
<div>
	<nav class="nav">
		<div class="container">
			<div class="logo">
				<a class="navbar-brand" href="main.jsp"> <img src="./images/fitnessIcon.png" width="30" height="30" alt=""> HOME FIT</a>
			</div>
				...
				<ul class="navlinks">
					...
					<li class="nav-item active dropdown">
						...
						<div class="dropdown-menu">
							...
							<a class="dropdown-item" href="#">트레이너 신청</a>
						</div>
					</li>
					<li class="nav-item active dropdown">
						<a href="#">커뮤니티</a>
						<div class="dropdown-menu">
							...
							<a class="dropdown-item" href="#">바디프로필</a>
						</div>
					</li>
				</ul>
			</div>
...
$(function () {
	$('#loginBtn').click(function() {
		location.href = "member?param=goLogin";
	})
});
...
$(function () {
	$('#regiBtn').click(function() {
		location.href = "member?param=goRegi";
	})
});
